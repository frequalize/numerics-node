(function() {
  ...
  Connection = (function() {
    ...
    Connection.prototype.times = function() {
      var args, callback, timeseries, _i;
      timeseries = arguments[0], args = 3 <= arguments.length ? __slice.call(arguments, 1, _i = arguments.length - 1) : (_i = 1, []), callback = arguments[_i++];
      return this.query(['times', timeseries].concat(__slice.call(this.parse_time_args(args))), false, callback);
    };
    Connection.prototype.values = function() {
      var args, callback, timeseries, _i;
      timeseries = arguments[0], args = 3 <= arguments.length ? __slice.call(arguments, 1, _i = arguments.length - 1) : (_i = 1, []), callback = arguments[_i++];
      return this.query(['values', timeseries].concat(__slice.call(this.parse_time_args(args))), false, callback);
    };
