(function() {
  ...
  Connection = (function() {
    ...
    function Connection(access_key) {
    ...
    Connection.prototype.send = function(method, path, body, callback) {
      ...
      request.setHeader('X-Access-Key', this.access_key.key);
      request.setHeader('X-Secret-Key', this.access_key.secret_key);
      if (false) {
    ...
    Connection.prototype.with_ws_client = function(callback) {
      if (this.ws) {
        ...
        return this.setup_ws_client(SIO.connect("ws:" + Connection.HOST + ":" + Connection.PORT, {
    ...
    Connection.prototype.setup_ws_client = function(ws, callback) {
      ...
      return ws.on('message', __bind(function(msg) {
