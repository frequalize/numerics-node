(function() {
  ...
  Connection = (function() {
    ...
    function Connection() {}
    Connection.prototype.list = function(timeseries, callback) {
      return this.query(['list'], false, callback);
    };
    Connection.prototype.about = function(timeseries, callback) {
      return this.query(['about', timeseries], false, callback);
    };
    Connection.prototype.create = function() {
      ...
      return this.query(['create', timeseries].concat(__slice.call(this.number_args(args))), false, callback);
    };
    Connection.prototype.erase = function(timeseries, callback) {
      return this.query(['erase', timeseries], false, callback);
    };
    ...
    Connection.prototype.query = function(query, keep_alive, callback) {
      ...
      request.write(JSON.stringify(['ns', 'test', query]));
      return request.end();
    };
    return Connection;
  })();
