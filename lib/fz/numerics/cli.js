  ...
  CLI = (function() {
    ...
    CLI.prototype.watch_command = function() {
      ...
      if (this.args.length > 0) {
        return (_ref = this.connection()).subscribe.apply(_ref, [this.timeseries].concat(__slice.call(this.args), [__bind(function(data) {
          return this.success(data);
        }, this)]));
      } else {
        return this.help(1, true);
