(function() {
  ...
  Connection = (function() {
    ...
    Connection.prototype.stats_per = function(timeseries, property_name, callback) {
      return this.get(timeseries, 'stats_per', {
        p: property_name
      }, callback);
    };

    Connection.prototype.stats_without_zeros = function() {
      var args, callback, timeseries, _i;
      timeseries = arguments[0], args = 3 <= arguments.length ? __slice.call(arguments, 1, _i = arguments.length - 1) : (_i = 1, []), callback = arguments[_i++];
      return this.get.apply(this, [timeseries, 'stats_without_zeros'].concat(__slice.call(args), [callback]));
    };

    Connection.prototype.tally_of = function() {
      var args, callback, query, timeseries, _i;
      timeseries = arguments[0], args = 3 <= arguments.length ? __slice.call(arguments, 1, _i = arguments.length - 1) : (_i = 1, []), callback = arguments[_i++];
      query = {};
      if (args.length > 0) query['v'] = args[0];
      return this.get(timeseries, 'tally_of', query, callback);
    };
    ...
    Connection.prototype.get = function() {
      ...
      if (query != null) path += '?' + QS.stringify(query);
    ...
    Connection.prototype.send = function(method, path, body, callback) {
      ...
      if (body != null) console.log("BODY: " + body);
    ...
    Connection.prototype.subscribe = function() {
      ...
      return this.with_ws_client(function(ws) {
    ...
    Connection.prototype.setup_ws_client = function(ws, callback) {
      ...
      ws.on('message', function(msg) {
        ...
        if (ts && event && _this.subscriptions[ts] && _this.subscriptions[ts][event]) {
          _ref = _this.subscriptions[ts][event];
          _results = [];
